...
class TestMatchingCasesExtractor(TestCase):
    ...
    def test_offset_results_with_more_diversity_are_handled_correctly(self):
        custom_offset_results = {
            ('transcript1.chr1.nnic', 'ENSMUST00000208994.2', '+'): [(-1, 0), (0, 0), (0, 4), (0, 0)],
            ('transcript2.chr1.nnic', 'ENSMUST00000208994.3', '+'): [(-1, 0), (0, 0), (4, 0), (0, 0)],
            ('transcript3.chr1.nnic', 'ENSMUST00000208994.4', '-'): [(-1, 0), (0, 0), (0, 4), (0, 0)],
            ('transcript4.chr1.nnic', 'ENSMUST00000208994.5', '-'): [(-1, 0), (0, 0), (4, 0), (0, 0)],
            ('transcript5.chr1.nnic', 'ENSMUST00000208994.6', '+'): [(-1, 0), (0, 0), (0, -4), (0, 0)],
            ('transcript6.chr1.nnic', 'ENSMUST00000208994.7', '+'): [(-1, 0), (0, 0), (-4, 0), (0, 0)],
            ('transcript7.chr1.nnic', 'ENSMUST00000208994.8', '-'): [(-1, 0), (0, 0), (0, -4), (0, 0)],
            ('transcript8.chr1.nnic', 'ENSMUST00000208994.9', '-'): [(-1, 0), (0, 0), (-4, 0), (0, 0)]
        }
