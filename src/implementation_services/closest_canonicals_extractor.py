...
def find_most_common_del_nucleotide_pair(nucleotides: str, dict_key: tuple, canonicals: list, intron_site_dict: dict):
    ...
    intron_site_dict[dict_key]["extracted_information"]["right"]["most_common_del"] = right_offset
    intron_site_dict[dict_key]["extracted_information"]["left"]["most_common_del"] = left_offset
